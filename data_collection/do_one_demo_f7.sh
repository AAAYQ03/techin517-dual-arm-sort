...
HF_HOME=/home/ubuntu/techin517/huggingface lerobot-record \
  ...
  --robot.cameras='{ wrist: {type: opencv, index_or_path: /dev/v4l/by-path/pci-0000:0e:00.0-usb-0:1.1:1.0-video-index0, width: 1280, height: 720, fps: 30, fourcc: MJPG}, top: {type: intelrealsense[...]' \
