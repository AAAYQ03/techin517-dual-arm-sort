#!/usr/bin/env python3
"""
leader_to_follower_f8.py - 让 leader 主动 servo 到 follower 当前位置, 然后 torque-off
解决 lerobot-record 启动时 follower 被 snap 到 leader 的痛点

用法 (在桀 ROS 之后, 启动 lerobot-record 之前):
    python3 ~/techin517/data_collection/leader_to_follower_f8.py
...
LEADER_PORT   = "/dev/serial/by-id/usb-1a86_USB_Single_Serial_5AB0183407-if00"
