...
import os, re
path = "/home/ubuntu/techin517/data_collection/pipeline_to_above_only.py"
...
echo ""
echo "=== 验证 ==="
grep "TEXT_PROMPT\|TARGET_CLASSES" /home/ubuntu/techin517/data_collection/pipeline_to_above_only.py

echo ""
echo "=== 启动 pipeline ==="
export DISPLAY=:2
python3 ~/techin517/data_collection/pipeline_to_above_only.py
